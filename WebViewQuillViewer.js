...
const requiredAsset = Platform.select({
    android: {uri: 'file:///android_asset/quill/reactQuillViewer-index.html'},
    ios: require(`./assets/quill/reactQuillViewer-index.html`),
    harmony: {uri: 'resource://rawfile/quill/reactQuillViewer-index.html'},
});
